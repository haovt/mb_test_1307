...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_feedback_modal__ = __webpack_require__(2161);
...
var AddonModAssignEditFeedbackModalPage = /** @class */ (function () {
    ...
    AddonModAssignEditFeedbackModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addon-mod-assign-edit-feedback-modal',template:/*ion-inline-start:"D:\git\moodle_mobile_HQ\moodle_mobile_HQ\moodleapp\src\addon\mod\assign\pages\edit-feedback-modal\edit-feedback-modal.html"*/'<ion-header>\n\n    <ion-navbar core-back-button>\n\n        <ion-title>{{ plugin.name }}</ion-title>\n\n        <ion-buttons end>\n\n            <button ion-button icon-only (click)="closeModal()" [attr.aria-label]="\'core.close\' | translate">\n\n                <ion-icon name="close"></ion-icon>\n\n            </button>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n    <form name="addon-mod_assign-edit-feedback-form" *ngIf="userId && plugin" #editFeedbackForm>\n\n        <addon-mod-assign-feedback-plugin [assign]="assign" [submission]="submission" [userId]="userId" [plugin]="plugin" [edit]="true"></addon-mod-assign-feedback-plugin>\n\n        <button ion-button block (click)="done($event)">{{ \'core.done\' | translate }}</button>\n\n    </form>\n\n</ion-content>\n\n'/*ion-inline-end:"D:\git\moodle_mobile_HQ\moodle_mobile_HQ\moodleapp\src\addon\mod\assign\pages\edit-feedback-modal\edit-feedback-modal.html"*/,
        }),
